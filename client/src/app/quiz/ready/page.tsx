      ...
      <TwoColumnLayout
        ...
        right={
          <div className='flex flex-col gap-4'>
            {/* Score card — context only, no buttons inside */}
              ...
              <div>
                ...
                <p className='text-app-text-secondary text-sm leading-relaxed max-w-xs mx-auto'>
                  {flow.questionType === 'theory' && flow.inputMode === 'oral'
                    ...
                    : 'Once you start, move through each question at your own pace. You can go back to review.'}
                </p>
              </div>
              ...
              {flow.questionType === 'theory' && flow.inputMode === 'oral' && (
                <div className='w-full bg-primary/10 border border-primary/25 rounded-xl p-4 text-left'>
                  ...
                  <ul className='text-app-text-secondary text-xs space-y-1 leading-relaxed'>
                    <li>• AI reads and highlights each word as it speaks</li>
                    <li>• Tap "Start Recording" when you're ready to answer</li>
                    <li>
                      • Tap "Stop Recording" when you're done — then review your
                      transcript
                    </li>
                  </ul>
                </div>
            ...
            {/* Start Quiz button — OUTSIDE the card */}
            <button
            ...
            {/* Tiny summary line — below the button */}
